...
# Plot all depths 
png("Pred20_TFe_hypo_4comp_2out_boot_090121.png",width = 9, height = 4, units = 'in', res = 300) 
TFe_plot <- ggplot() +
...
write.csv(TS_conc_all,"MUX20_predictions_boot_092021.csv")

#write csv of dataWQ
write.csv(dataWQ,"MUX20_dataWQ_092021.csv")
