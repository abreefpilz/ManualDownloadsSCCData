...
End_time<- c("2020-11-09 14:00:00") #make sure this is after the last FP *and* sampling times!
...
data_prep(WQ,FPcaldata_name,TimeSeriesFP_name,Depths,Begin_time,End_time,WQparam)
...
png("MUX_TFe_2020_pred_nine_m.png",width = 9, height = 4, units = 'in', res = 300) 
TFe_plot <- ggplot() +
  geom_path(data=nine_m, aes(x=DateTime,y=TFe_mgl), size=0.5) +
