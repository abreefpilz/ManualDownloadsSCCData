...
old_fp <-read.table(file=paste0("./FP_2021/","106104B8.FP"),skip=2,header=FALSE, row.names = NULL, sep = "\t")
...
write.table(new_fp, file = "./FP_2021/106104B8_edited.FP", quote = FALSE, row.names = FALSE)
