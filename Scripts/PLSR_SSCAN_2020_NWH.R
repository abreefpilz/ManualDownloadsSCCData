...
#### Read in FCR WQ data ####
WQ<-"FCR_Jan_Aug_2020.xlsx" #Specify file where data is located 
...
TFe_plot <- ggplot() +
  ...
  geom_point(data=dataWQ, aes(x=Date, y=TFe_mgl), colour="blue") +
  #ylim(-5, 50)+
  labs(x="Date", y = "TFe_mgl", title = "Predicted TFe at 1.6m, 2020") +
